...
export const COMPANY_UNIVERSE: CompanyCandidate[] = [
  ...
  },
  {
    ...
    country: "CA",
    commodityFocus: ["Gold"],
    aliases: ["G Mining Ventures", "GMIN", "GMIN.TO", "GMINF"],
  ...
  },
  {
    ...
    country: "CA",
    commodityFocus: ["Copper"],
    aliases: ["Arizona Sonoran", "ASCUF"],
    websiteUrl: "https://arizonasonoran.com/",
    description: "Copper developer advancing the Cactus project in Arizona.",
    projects: ["Cactus project"],
    jurisdiction: "Arizona, United States",
    stage: "Development"
  }
];
